      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <Link href="/" className="flex items-center gap-1.5">
            ...
            <span className="font-bold text-lg tracking-tight text-[var(--ep-green)]">EcoPlate</span>
          </Link>

          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-[var(--ep-neutral)]">
            <Link href="/#how-it-works" className="hover:text-[var(--ep-green)] transition-colors">How It Works</Link>
            <Link href="/#impact" className="hover:text-[var(--ep-green)] transition-colors">Impact</Link>
            <Link href="/#partners" className="hover:text-[var(--ep-green)] transition-colors">Partners</Link>
          </nav>

          <div className="hidden md:flex items-center gap-3">
            <Link href="/login" className="text-sm font-medium text-[var(--ep-green)] hover:underline">Login</Link>
            <Link href="/signup" className="btn-cta text-sm">Get Started</Link>
          </div>

          <button className="md:hidden p-2 rounded-md text-[var(--ep-neutral)]" onClick={() => setOpen((o) => !o)}>
