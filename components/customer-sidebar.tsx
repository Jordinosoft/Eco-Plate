    ...
    <aside className="w-64 shrink-0 min-h-screen bg-white border-r border-gray-100 flex flex-col">
      ...
      <div className="px-5 py-5 border-b border-gray-100">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-bold text-gray-900">FoodLoop</span>
        </Link>
      </div>
      ...
      <nav className="flex flex-col gap-1 p-3 flex-1">
        ...
        <Link
          href="/marketplace"
          className="mt-4 btn-cta justify-center text-sm py-2.5"
        >
      ...
      <div className="p-3 border-t border-gray-100 flex flex-col gap-1">
        <Link href="#" className="flex items-center gap-3 rounded-xl px-3 py-2 text-sm text-[var(--ep-neutral)] hover:bg-gray-50 transition">
