    ...
    <aside className="hidden lg:flex flex-col w-52 shrink-0 border-r border-gray-100 bg-white min-h-screen sticky top-0">
      <div className="px-4 py-4 border-b border-gray-100">
        <div className="flex items-center gap-1.5">
          ...
          <div>
            <p className="font-bold text-[var(--ep-green)] text-sm leading-none">FoodLoop</p>
            <p className="text-xs text-[var(--ep-neutral)]">Portal</p>
          </div>
        </div>
  ...
  return (
    <header className="flex items-center justify-between px-6 py-3 bg-white border-b border-gray-100 sticky top-0 z-10">
      <div className="relative flex-1 max-w-xs">
        <input
          type="text"
          placeholder="Search surplus food batches..."
      ...
      <div className="flex items-center gap-3 ml-4">
        ...
        <div className="h-8 w-8 rounded-full bg-[var(--ep-green-light)] flex items-center justify-center text-xs font-bold text-[var(--ep-green)]">
          NG
        </div>
      </div>
    </header>
