    ...
    <aside className="hidden lg:flex flex-col w-56 shrink-0 border-r border-gray-100 bg-white min-h-screen sticky top-0">
      ...
      <div className="px-5 py-4 border-b border-gray-100">
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-bold text-[var(--ep-green)] text-sm">
            GreenBite Merchant
          </span>
        </div>
      </div>
      ...
      <div className="px-4 py-3 border-b border-gray-50">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--ep-neutral)]">greenbite.app</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 py-3 border-t border-gray-100 flex flex-col gap-0.5">
        <Link
          href="#"
          className="flex items-center gap-2.5 rounded-lg px-3 py-2 text-sm text-[var(--ep-neutral)] hover:bg-gray-50 transition"
        >
      ...
      <div className="px-3 pb-4">
        <Link
          ...
          className="btn-cta w-full justify-center text-xs py-2 gap-1.5"
        >
